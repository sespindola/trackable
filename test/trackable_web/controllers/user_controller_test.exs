defmodule TrackableWeb.UserControllerTest do
  use TrackableWeb.ConnCase

  alias Trackable.Accounts
  alias Trackable.Accounts.User

  @create_attrs %{disabled: true, email: "some email", fullname: "some fullname", role: "some role", status: "some status", username: "some username"}
